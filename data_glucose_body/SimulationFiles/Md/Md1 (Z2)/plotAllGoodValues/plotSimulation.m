...
firstparam(1)=0;
firstparam(2)=0;
firstparam(3:18)=param;
try
  simDataSteadyState = SBAOsimulate(modelName,1000,icOrig,names,firstparam,simOptions);
  simDataSteadyStateWb = SBAOsimulate(modelNameWb,2000,icOrigWb,names,firstparam,simOptions);
...
for i=1:2
    sim5GLU(i)=simData5(i).reactionvalues(end,1);
    sim5GLU1(i)=simData5(i).reactionvalues(end,2);
    sim5GLU4(i)=simData5(i).reactionvalues(end,3);
end
sim5GLU(3)=simData5(8).reactionvalues(end,1);
sim5GLU1(3)=simData5(8).reactionvalues(end,2);
sim5GLU4(3)=simData5(8).reactionvalues(end,3);
for i=3:7
    sim5GLU(i+1)=simData5(i).reactionvalues(end,1);
    sim5GLU1(i+1)=simData5(i).reactionvalues(end,2);
    sim5GLU4(i+1)=simData5(i).reactionvalues(end,3);
end
...
figure(7)
semilogx(insulinConcentration2,sim5GLU,'b-');
figure(10)
