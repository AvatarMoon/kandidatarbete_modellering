...
firstparam(1)=0;
firstparam(2)=0;
firstparam(3:24)=param;
firstparamWb(1)=0;
firstparamWb(2)=130;
firstparamWb(3:24)=param;
try
...
%Simulation of dose-response glucose uptake (5.0 mM glucose)
for i=1:8
...
try
    for i=1:8
        simData5(i) = SBAOsimulate(modelName,30,initcondGlu(:,i),names,paramGlu5(:,i),simOptions);
    end
catch disp('Now the Glu dose-response simulation crashed...');
    error = inf;
    return 
