...
hold on
for i=1:11
    plot(EXPDATA_WB_15.time(i),EXPDATA_WB_15.response(i),'ro','MarkerFaceColor','r','MarkerSize',10,'Linewidth',2);
    line([EXPDATA_WB_15.time(i) EXPDATA_WB_15.time(i)],[EXPDATA_WB_15.response(i)-EXPDATA_WB_15.sem EXPDATA_WB_15.response(i)+EXPDATA_WB_15.sem],'Color','r','Linewidth',2)
end
set(h,'box','off');
